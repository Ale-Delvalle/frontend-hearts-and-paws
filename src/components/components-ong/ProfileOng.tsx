...
const ProfileOng = () => {
  ...
  return (
    <div className="text-gray-800 dark:text-white">
      <h2 className="text-[27px] font-bold mb-6 text-[#FA8072] dark:text-[#FA8072]">Perfil de la ONG</h2>
      ...
      {ong.imagenPerfil && (
        <div className="mt-6">
          <img
            ...
            className="w-48 h-48 object-cover rounded-full border-4 border-[#e87366] shadow-md"
          />
        </div>
      )}
    </div>
